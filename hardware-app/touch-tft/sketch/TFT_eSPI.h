...
// Include the processor specific drivers
  ...
  #include "TFT_eSPI_ESP32_S3.h"
#elif defined(CONFIG_IDF_TARGET_ESP32C3)
  #include "TFT_eSPI_ESP32_C3.h"
#elif defined (ESP32)
  #include "TFT_eSPI_ESP32.h"
#elif defined (ARDUINO_ARCH_ESP8266)
  #include "TFT_eSPI_ESP8266.h"
#elif defined (STM32)
  #include "TFT_eSPI_STM32.h"
#elif defined(ARDUINO_ARCH_RP2040)
  #include "TFT_eSPI_RP2040.h"
#else
...
#ifdef TOUCH_CS
  // Embedded Touch.h to avoid cloud compiler include resolution errors
  public:
...
#ifdef SMOOTH_FONT
  #include "Smooth_font.h"  // Loaded if SMOOTH_FONT is defined by user
#endif
