...
#include "TFT_eSPI.h"
    ...
    #include "TFT_eSPI_ESP32_S3.c" // Tested with SPI and 8-bit parallel
  #elif defined(CONFIG_IDF_TARGET_ESP32C3)
    #include "TFT_eSPI_ESP32_C3.c" // Tested with SPI (8-bit parallel will probably work too!)
  #else
    #include "TFT_eSPI_ESP32.c"
  #endif
#elif defined (ARDUINO_ARCH_ESP8266)
  #include "TFT_eSPI_ESP8266.c"
#elif defined (STM32) // (_VARIANT_ARDUINO_STM32_) stm32_def.h
  #include "TFT_eSPI_STM32.c"
#elif defined (ARDUINO_ARCH_RP2040)  || defined (ARDUINO_ARCH_MBED) // Raspberry Pi Pico
  #include "TFT_eSPI_RP2040.c"
#else
  #include "TFT_eSPI_Generic.c"
#endif
...
void TFT_eSPI::init(uint8_t tc)
{
  ...
  // This loads the driver specific initialisation code  <<<<<<<<<<<<<<<<<<<<< ADD NEW DRIVERS TO THE LIST HERE <<<<<<<<<<<<<<<<<<<<<<<
	...
	#include "RM68140_Init.h"

#elif defined (ST7789_2_DRIVER)
    #include "ST7789_2_Init.h"

#elif defined (SSD1351_DRIVER)
    #include "SSD1351_Init.h"

#elif defined (SSD1963_DRIVER)
    #include "SSD1963_Init.h"

#elif defined (GC9A01_DRIVER)
     #include "GC9A01_Init.h"

#elif defined (ILI9225_DRIVER)
     #include "ILI9225_Init.h"

#elif defined (RM68120_DRIVER)
     #include "RM68120_Init.h"

#elif defined (HX8357B_DRIVER)
    #include "HX8357B_Init.h"

#elif defined (HX8357C_DRIVER)
    #include "HX8357C_Init.h"
...
#elif defined (RM68140_DRIVER)
	#include "RM68140_Rotation.h"

#elif defined (ST7789_2_DRIVER)
    #include "ST7789_2_Rotation.h"

#elif defined (SSD1351_DRIVER)
    #include "SSD1351_Rotation.h"

#elif defined (SSD1963_DRIVER)
    #include "SSD1963_Rotation.h"

#elif defined (GC9A01_DRIVER)
     #include "GC9A01_Rotation.h"

#elif defined (ILI9225_DRIVER)
     #include "ILI9225_Rotation.h"

#elif defined (RM68120_DRIVER)
     #include "RM68120_Rotation.h"

#elif defined (HX8357B_DRIVER)
    #include "HX8357B_Rotation.h"

#elif defined (HX8357C_DRIVER)
    #include "HX8357C_Rotation.h"
...
#ifdef SMOOTH_FONT
  #include "Smooth_font.cpp"
#endif

#ifdef AA_GRAPHICS
  #include "AA_graphics.cpp"  // Loaded if SMOOTH_FONT is defined by user
#endif
////////////////////////////////////////////////////////////////////////////////////////
